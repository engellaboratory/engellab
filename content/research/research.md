...
<figure> <img src="/media/img/Fig1AB.png" class="research-icon-right" style="height:700px;">
</figure>
...
Using the Four Core Genotypes model, we can reveal the driving factors behind sex biases in melanoma. To uncover these factors, we inject male and female mouse melanoma cells into mice from this model and analyze tumor growth kinetics, along with metastatic potential of the tumors. By injecting male and female cells into this model, we can elucidate how biological sex and sex chromosome composition of both the host and tumor microenvironment influence tumor growth. Ultimately, these experiments allow us to understand the individual and synergistic effects that the sex chromosomes and sex hormones have on melanoma progression. 

## Dosage Effects of Transcription Factors

Transcription factors are overrepresented among haploinsufficient disorders, suggesting that dosage effects are important for many of them. We study whether sex differences in transcription and epigenetic factors affect their genome-wide distribution and whether their downstream targets are activated in a dosage-sensitive manner. We have engineered tags for several sex-biased transcription factors with CRISPR/Cas technology to determine their genomic occupancy by ChIP-seq and the potential sex differences in their effects on target genes before and after differentiation into cardiac precursors. We also perform CUT and RUN on mouse melanoma cells and tumors targeting transcription and epigenetic factors to reveal where they interact with the genome.